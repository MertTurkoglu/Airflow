...
dag = DAG("dummy_operator", default_args=default_args, schedule_interval='@daily',catchup=False)
...
# arada dummy operatoru kullanmasaydık hata alırdık 
# taskleri gruplamak istediğimiz zaman dummy operatörünü kullanıyoruz
